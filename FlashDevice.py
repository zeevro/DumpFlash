...
import pprint
import traceback
from pyftdi.ftdi import *  # pylint: disable=unused-wildcard-import
from DumpUBoot import *  # pylint: disable=unused-wildcard-import
from ECC import *
...
class NandIO:
    ...
    def writeBlock(self, block_data):
        self.EraseBlockByPage(0)  # need to fix
        page = 0
        for i in range(0, len(block_data), self.RawPageSize):
            self.WritePage(i, block_data[i:i + self.RawPageSize])
            page += 1
