    ...
    def Parse(self, filename, target_filename=''):
        ...
        while 1:
            ...
            if nodetype == JFFS2_NODETYPE_INODE:
                ...
                (hdr_crc, pino, version, ino, mctime, nsize, ent_type, _unused, node_crc, name_crc) = struct.unpack(dirent_unpack_fmt, data[data_offset + header_struct_size:data_offset + header_struct_size + dirent_struct_size])
